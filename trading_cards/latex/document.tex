...
\newcommand{\copyrightname}{Van Klaren Quidditch Photography}
\newcommand{\overlay}{Refs} %Refs, Hamburg
\newcommand{\playername}{Timo Ramsau}
\newcommand{\playernumber}{01}
\newcommand{\position}{Keeper, Chaser, Seeker}
\newcommand{\motto}{Sed ut perspiciatis unde omnis iste natus error sit voluptatem }
...
\begin{textblock*}{55mm}(7.3mm,64mm + \perfecthight - \originalhight)
...
% Position
\begin{textblock*}{40mm}(7.3mm,70.5mm)
...
\settoheight{\originalhight}{\parbox{40mm}{
	\fontsize{9}{9} \selectfont \textit{\textbf{\motto}}}}
\begin{textblock*}{40mm}(25mm,78mm)
	\raggedright
\ifdim \originalhight > \maxhight%
	\begin{fitbox}{40mm}{\maxhight}\raggedright
		\selectfont \textit{\textbf{\motto}}
	\end{fitbox}
\else%
	\raggedright\parbox{40mm}{\raggedright\fontsize{9}{9} \selectfont  \textit{\textbf{\motto}}}
\fi%
\end{textblock*}

% Function
\begin{textblock*}{39mm}(7.3mm,88mm)
...
\begin{textblock*}{800mm}(9.7mm-\unturnedhight,15mm)
	\begin{turn}{-90}
