...
\begin{textblock*}{40mm}(7.3mm,70.5mm)
	\noindent \fontsize{8}{8} \selectfont \position
\end{textblock*}
...
\settoheight{\originalhight}{\parbox{40mm}{
	\fontsize{6}{9} \selectfont \textit{\textbf{\motto}}}}
...
\ifdim \originalhight > \maxhight%
	...
	\end{fitbox}
\else%
	\raggedright\parbox{40mm}{\raggedright\fontsize{6}{9} \selectfont  \textit{\textbf{\motto}}}
\fi%
\end{textblock*}
...
\begin{textblock*}{800mm}(9.7mm-\unturnedhight,17mm)
	\begin{turn}{-90}
